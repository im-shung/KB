...
public class EmployeeServiceTest {
	public static void main(String[] args) {
		...
		System.out.println("\n============ 4. findManager(BBB) ============ ");
		Employee retE1=service.findEmployee("BBB");
		System.out.println(retE1);
		
		System.out.println("\n============ 4. findManager(10) ============ ");
		System.out.println("10번 부서에 근무하는 직원들 입니다..");
		Employee[ ] retEs1 = service.findEmployee(10);
		for(Employee e : retEs1) {
			if(e==null) continue;
			System.out.println(e);
		}
		
		System.out.println("\n============ 5. getAnnualSalary(EEE) (EEE 연봉 출력) ============ ");
		System.out.println("EEE의 연봉입니다..");
		Employee e = service.findEmployee("FFF");
		if (e != null)
			System.out.println(service.getAnnualSalary(e) + " 만원");
		
		System.out.println("\n============ 5. getAnnualSalary(EEE) (총 인건비) ============ ");
		System.out.println("총 인건비 입니다..");
