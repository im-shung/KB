 ...
 * 
 */
public class ControllerFactrory {
	/* 싱글톤 */
	private static ControllerFactrory factory = new ControllerFactrory();
	private ControllerFactrory() {}
	public static ControllerFactrory getInstance() {
		return factory;
	}
